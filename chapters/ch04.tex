...
\chapter{Skill体系：赋予AI金融专业能力}
\chapteroverview{
本章学习目标：
\begin{enumerate}
  \item 理解Skill的设计原理与知识工程视角
  \item 掌握金融类Skill的调用方法
...
\toprule
\textbf{Skill名称} & \textbf{分类} & \textbf{核心能力} \\
\midrule
...
% -----------------------------------------------------------
\subsection{docx Skill：银行客户回访报告（★）}
% -----------------------------------------------------------
...
% -----------------------------------------------------------
\subsection{finance-expert Skill：信用风险评估（★★）}
% -----------------------------------------------------------
...
% -----------------------------------------------------------
\subsection{xlsx Skill：贷款FTP定价模型（★★★）}
% -----------------------------------------------------------
...
\subsection{实战：编写bank-risk-alert Skill（★★★）}
...
\keyterms{Skill、SKILL.md、触发词、MCP vs Skill、知识工程、FTP转移定价、五C模型、RFM分群、数据脱敏、合规审计、五维审计法、金融数据分类分级}
