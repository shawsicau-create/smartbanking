...
\textbf{方案一：Vercel}。Vercel支持部署纯静态网站，操作步骤：
\begin{enumerate}[leftmargin=2em]
  \item 将\texttt{web/}目录推送到GitHub仓库
  \item 在Vercel中导入该仓库
  \item 设置输出目录为\texttt{web}
  \item 一键部署，获得\texttt{xxx.vercel.app}域名
\end{enumerate}
...
B-004 & 部署到公网 & 部署到Vercel/Netlify，可公网访问 & +5分 \\
