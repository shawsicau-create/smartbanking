...
```mermaid
flowchart TB
    subgraph Book["智慧银行实验教程"]
        subgraph Basic["基础模块 第1-5章"]
            Ch1["第1章 绪论"]
            Ch2["第2章 环境搭建"]
            Ch3["第3章 MCP协议"]
            Ch4["第4章 Skill体系"]
        ...
        subgraph Advanced["进阶模块 第6章"]
            Ch6["第6章 金融数据分析"]
        end
        
        subgraph Comprehensive["综合模块 第7-8章"]
            Ch7["第7章 BMAD方法论"]
            Ch8["第8章 综合项目与创新"]
        end
    ...
    style Comprehensive fill:#fff3e0
    style Appendix fill:#fce4ec
```
...
- **64学时完整版**：建议覆盖全部8章+附录实操。此方案在标准版基础上加深MCP深度开发、Skill库构建和CLI自动化，适合金融科技专业核心课程。
...
flowchart LR
    ...
    style Prerequisites fill:#e1f5fe
