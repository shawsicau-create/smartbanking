...
name: plugin-creator
version: 1.4.0
description: Create, customize, or modify QoderWork expert plugins. Use when the user
  wants to create a new plugin, customize an existing plugin, or edit a plugin's skills/commands.
