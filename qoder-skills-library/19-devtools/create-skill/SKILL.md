...
name: create-skill
version: 1.0.0
description: Guides users through creating effective Agent Skills for QoderWork. Use
  when the user wants to create, write, or author a new skill, or asks about skill
  structure, best practices, or SKILL.md format.
description_zh: 引导用户为 QoderWork 创建有效的 Agent 技能。当用户想要创建、编写或制作新技能，或询问技能结构、最佳实践或 SKILL.md
  格式时使用。
