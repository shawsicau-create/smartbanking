...
version: 1.0.0
description: Diagnose and fix missing dependencies, binaries, or runtime environments
  required by installed skills. Use when a skill fails due to missing resources, unresolved
  binaries, unavailable runtime dependencies, or when the user wants to proactively
