...
> **为什么选择 EdgeOne Pages？**
> EdgeOne Pages 是腾讯云提供的全球 CDN 静态网站托管服务，具有国内访问速度快、免费额度充足、与 CNB 无缝集成等优势。
...
> ⚠️ **安全要点**：Token 等敏感信息**绝不能**写入代码文件，必须使用密钥仓库管理。
...
> 💡 **建议**：推送前先用 `pnpm dev` 在本地预览确认效果，避免推送后发现问题。
